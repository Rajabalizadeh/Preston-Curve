...
author: "Javad Rajabalizadeh"
institute: "TRR 266/trer "Accounting for Transparency" course"
...
latex_tab <- c(
  ...
  sprintf(
    "\\item Note: The data is obtained from the World Bank. (Sample: %d countries _ Period: %d to %d. \\textit{National Income per captia} values are in constant 2010 thousand U.S. dollars.", length(unique(smp$country)),
...
### Life Expectancy by National Income scatter plot
